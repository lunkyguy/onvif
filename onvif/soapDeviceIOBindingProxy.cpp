...
{	struct soap *soap = this->soap;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tmd__GetAudioSourcesResponse->soap_get(soap, "tmd:GetAudioSourcesResponse", "tmd:GetResponse");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct soap *soap = this->soap;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tmd__GetAudioOutputsResponse->soap_get(soap, "tmd:GetAudioOutputsResponse", "tmd:GetResponse");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct soap *soap = this->soap;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tmd__GetVideoSourcesResponse->soap_get(soap, "tmd:GetVideoSourcesResponse", "tmd:GetResponse");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct soap *soap = this->soap;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tmd__GetDigitalInputConfigurationOptionsResponse->soap_get(soap, "tmd:GetDigitalInputConfigurationOptionsResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct soap *soap = this->soap;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tmd__SetDigitalInputConfigurationsResponse->soap_get(soap, "tmd:SetDigitalInputConfigurationsResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
