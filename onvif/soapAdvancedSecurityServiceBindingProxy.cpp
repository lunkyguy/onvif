...
{	struct soap *soap = this->soap;
	...
	soap_tmp___name__GetServiceCapabilities.ns5__GetServiceCapabilities = ns5__GetServiceCapabilities;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name__GetServiceCapabilities(soap, &soap_tmp___name__GetServiceCapabilities);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name__GetServiceCapabilities(soap, &soap_tmp___name__GetServiceCapabilities, "-name:GetServiceCapabilities", NULL)
