...
static int serve___name12__GetMessages(PullPointBindingService*);
static int serve___name12__DestroyPullPoint(PullPointBindingService*);
static int serve___name12__Notify(PullPointBindingService*);
...
{	PullPointBindingService_init(this->soap->imode, this->soap->omode);
	...
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:GetMessages"))
		return serve___name12__GetMessages(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:DestroyPullPoint"))
		return serve___name12__DestroyPullPoint(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:Notify"))
		return serve___name12__Notify(this);
	return this->soap->error = SOAP_NO_METHOD;
}

static int serve___name12__GetMessages(PullPointBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name12__GetMessages(soap, &soap_tmp___name12__GetMessages);
	if (!soap_get___name12__GetMessages(soap, &soap_tmp___name12__GetMessages, "-name12:GetMessages", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetMessages(soap_tmp___name12__GetMessages.wsnt__GetMessages, &wsnt__GetMessagesResponse);
	if (soap->error)
		return soap->error;
...
static int serve___name12__DestroyPullPoint(PullPointBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name12__DestroyPullPoint(soap, &soap_tmp___name12__DestroyPullPoint);
	if (!soap_get___name12__DestroyPullPoint(soap, &soap_tmp___name12__DestroyPullPoint, "-name12:DestroyPullPoint", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->DestroyPullPoint(soap_tmp___name12__DestroyPullPoint.wsnt__DestroyPullPoint, &wsnt__DestroyPullPointResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name12__Notify(PullPointBindingService *service)
{	struct soap *soap = service->soap;
	struct __name12__Notify soap_tmp___name12__Notify;
	soap_default___name12__Notify(soap, &soap_tmp___name12__Notify);
	if (!soap_get___name12__Notify(soap, &soap_tmp___name12__Notify, "-name12:Notify", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->Notify(soap_tmp___name12__Notify.wsnt__Notify);
	if (soap->error)
		return soap->error;
	return soap_closesock(soap);
}
