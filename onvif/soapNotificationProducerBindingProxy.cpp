...
int NotificationProducerBindingProxy::Subscribe(const char *endpoint, const char *soap_action, _wsnt__Subscribe *wsnt__Subscribe, _wsnt__SubscribeResponse *wsnt__SubscribeResponse)
{	struct soap *soap = this->soap;
	...
	soap_tmp___name10__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name10__Subscribe(soap, &soap_tmp___name10__Subscribe);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name10__Subscribe(soap, &soap_tmp___name10__Subscribe, "-name10:Subscribe", NULL)
...
int NotificationProducerBindingProxy::GetCurrentMessage(const char *endpoint, const char *soap_action, _wsnt__GetCurrentMessage *wsnt__GetCurrentMessage, _wsnt__GetCurrentMessageResponse *wsnt__GetCurrentMessageResponse)
{	struct soap *soap = this->soap;
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name10__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name10__GetCurrentMessage(soap, &soap_tmp___name10__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name10__GetCurrentMessage(soap, &soap_tmp___name10__GetCurrentMessage, "-name10:GetCurrentMessage", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
