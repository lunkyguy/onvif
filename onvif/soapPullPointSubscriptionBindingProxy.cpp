...
{	struct soap *soap = this->soap;
	...
	soap_tmp___name7__PullMessages.tev__PullMessages = tev__PullMessages;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name7__PullMessages(soap, &soap_tmp___name7__PullMessages);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name7__PullMessages(soap, &soap_tmp___name7__PullMessages, "-name7:PullMessages", NULL)
...
{	struct soap *soap = this->soap;
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name7__Seek.tev__Seek = tev__Seek;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name7__Seek(soap, &soap_tmp___name7__Seek);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name7__Seek(soap, &soap_tmp___name7__Seek, "-name7:Seek", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this->soap;
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name7__SetSynchronizationPoint.tev__SetSynchronizationPoint = tev__SetSynchronizationPoint;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name7__SetSynchronizationPoint(soap, &soap_tmp___name7__SetSynchronizationPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name7__SetSynchronizationPoint(soap, &soap_tmp___name7__SetSynchronizationPoint, "-name7:SetSynchronizationPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this->soap;
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name7__Unsubscribe.wsnt__Unsubscribe = wsnt__Unsubscribe;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name7__Unsubscribe(soap, &soap_tmp___name7__Unsubscribe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name7__Unsubscribe(soap, &soap_tmp___name7__Unsubscribe, "-name7:Unsubscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
