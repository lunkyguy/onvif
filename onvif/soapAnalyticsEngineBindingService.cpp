...
{	AnalyticsEngineBindingService *dup = SOAP_NEW_COPY(AnalyticsEngineBindingService);
	if (dup)
...
const SOAP_ENV__Header *AnalyticsEngineBindingService::soap_header()
...
static int serve___name6__GetServiceCapabilities(AnalyticsEngineBindingService*);
static int serve___name6__GetSupportedAnalyticsModules(AnalyticsEngineBindingService*);
static int serve___name6__CreateAnalyticsModules(AnalyticsEngineBindingService*);
static int serve___name6__DeleteAnalyticsModules(AnalyticsEngineBindingService*);
static int serve___name6__GetAnalyticsModules(AnalyticsEngineBindingService*);
static int serve___name6__GetAnalyticsModuleOptions(AnalyticsEngineBindingService*);
static int serve___name6__ModifyAnalyticsModules(AnalyticsEngineBindingService*);

int AnalyticsEngineBindingService::dispatch()
{	AnalyticsEngineBindingService_init(this->soap->imode, this->soap->omode);
	soap_peek_element(this->soap);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetServiceCapabilities"))
		return serve___name6__GetServiceCapabilities(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetSupportedAnalyticsModules"))
		return serve___name6__GetSupportedAnalyticsModules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:CreateAnalyticsModules"))
		return serve___name6__CreateAnalyticsModules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:DeleteAnalyticsModules"))
		return serve___name6__DeleteAnalyticsModules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetAnalyticsModules"))
		return serve___name6__GetAnalyticsModules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetAnalyticsModuleOptions"))
		return serve___name6__GetAnalyticsModuleOptions(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:ModifyAnalyticsModules"))
		return serve___name6__ModifyAnalyticsModules(this);
	return this->soap->error = SOAP_NO_METHOD;
}

static int serve___name6__GetServiceCapabilities(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__GetServiceCapabilities(soap, &soap_tmp___name6__GetServiceCapabilities);
	if (!soap_get___name6__GetServiceCapabilities(soap, &soap_tmp___name6__GetServiceCapabilities, "-name6:GetServiceCapabilities", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetServiceCapabilities(soap_tmp___name6__GetServiceCapabilities.tan__GetServiceCapabilities, &tan__GetServiceCapabilitiesResponse);
	if (soap->error)
		return soap->error;
...
static int serve___name6__GetSupportedAnalyticsModules(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__GetSupportedAnalyticsModules(soap, &soap_tmp___name6__GetSupportedAnalyticsModules);
	if (!soap_get___name6__GetSupportedAnalyticsModules(soap, &soap_tmp___name6__GetSupportedAnalyticsModules, "-name6:GetSupportedAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetSupportedAnalyticsModules(soap_tmp___name6__GetSupportedAnalyticsModules.tan__GetSupportedAnalyticsModules, &tan__GetSupportedAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name6__CreateAnalyticsModules(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__CreateAnalyticsModules(soap, &soap_tmp___name6__CreateAnalyticsModules);
	if (!soap_get___name6__CreateAnalyticsModules(soap, &soap_tmp___name6__CreateAnalyticsModules, "-name6:CreateAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->CreateAnalyticsModules(soap_tmp___name6__CreateAnalyticsModules.tan__CreateAnalyticsModules, &tan__CreateAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name6__DeleteAnalyticsModules(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__DeleteAnalyticsModules(soap, &soap_tmp___name6__DeleteAnalyticsModules);
	if (!soap_get___name6__DeleteAnalyticsModules(soap, &soap_tmp___name6__DeleteAnalyticsModules, "-name6:DeleteAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->DeleteAnalyticsModules(soap_tmp___name6__DeleteAnalyticsModules.tan__DeleteAnalyticsModules, &tan__DeleteAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name6__GetAnalyticsModules(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__GetAnalyticsModules(soap, &soap_tmp___name6__GetAnalyticsModules);
	if (!soap_get___name6__GetAnalyticsModules(soap, &soap_tmp___name6__GetAnalyticsModules, "-name6:GetAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetAnalyticsModules(soap_tmp___name6__GetAnalyticsModules.tan__GetAnalyticsModules, &tan__GetAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name6__GetAnalyticsModuleOptions(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__GetAnalyticsModuleOptions(soap, &soap_tmp___name6__GetAnalyticsModuleOptions);
	if (!soap_get___name6__GetAnalyticsModuleOptions(soap, &soap_tmp___name6__GetAnalyticsModuleOptions, "-name6:GetAnalyticsModuleOptions", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetAnalyticsModuleOptions(soap_tmp___name6__GetAnalyticsModuleOptions.tan__GetAnalyticsModuleOptions, &tan__GetAnalyticsModuleOptionsResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name6__ModifyAnalyticsModules(AnalyticsEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name6__ModifyAnalyticsModules(soap, &soap_tmp___name6__ModifyAnalyticsModules);
	if (!soap_get___name6__ModifyAnalyticsModules(soap, &soap_tmp___name6__ModifyAnalyticsModules, "-name6:ModifyAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->ModifyAnalyticsModules(soap_tmp___name6__ModifyAnalyticsModules.tan__ModifyAnalyticsModules, &tan__ModifyAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
