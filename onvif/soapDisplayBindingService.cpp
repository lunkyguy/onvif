...
{	DisplayBindingService_init(this->soap->imode, this->soap->omode);
	...
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:GetServiceCapabilities"))
		return serve___tls__GetServiceCapabilities(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:GetLayout"))
		return serve___tls__GetLayout(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:SetLayout"))
		return serve___tls__SetLayout(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:GetDisplayOptions"))
		return serve___tls__GetDisplayOptions(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:GetPaneConfigurations"))
		return serve___tls__GetPaneConfigurations(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:GetPaneConfiguration"))
		return serve___tls__GetPaneConfiguration(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:SetPaneConfigurations"))
		return serve___tls__SetPaneConfigurations(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:SetPaneConfiguration"))
		return serve___tls__SetPaneConfiguration(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:CreatePaneConfiguration"))
		return serve___tls__CreatePaneConfiguration(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tls:DeletePaneConfiguration"))
