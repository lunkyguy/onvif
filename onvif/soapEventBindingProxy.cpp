...
int EventBindingProxy::GetServiceCapabilities(const char *endpoint, const char *soap_action, _tev__GetServiceCapabilities *tev__GetServiceCapabilities, _tev__GetServiceCapabilitiesResponse *tev__GetServiceCapabilitiesResponse)
{	struct soap *soap = this->soap;
	...
	soap_tmp___name8__GetServiceCapabilities.tev__GetServiceCapabilities = tev__GetServiceCapabilities;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name8__GetServiceCapabilities(soap, &soap_tmp___name8__GetServiceCapabilities);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name8__GetServiceCapabilities(soap, &soap_tmp___name8__GetServiceCapabilities, "-name8:GetServiceCapabilities", NULL)
...
int EventBindingProxy::CreatePullPointSubscription(const char *endpoint, const char *soap_action, _tev__CreatePullPointSubscription *tev__CreatePullPointSubscription, _tev__CreatePullPointSubscriptionResponse *tev__CreatePullPointSubscriptionResponse)
{	struct soap *soap = this->soap;
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name8__CreatePullPointSubscription.tev__CreatePullPointSubscription = tev__CreatePullPointSubscription;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name8__CreatePullPointSubscription(soap, &soap_tmp___name8__CreatePullPointSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name8__CreatePullPointSubscription(soap, &soap_tmp___name8__CreatePullPointSubscription, "-name8:CreatePullPointSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int EventBindingProxy::GetEventProperties(const char *endpoint, const char *soap_action, _tev__GetEventProperties *tev__GetEventProperties, _tev__GetEventPropertiesResponse *tev__GetEventPropertiesResponse)
{	struct soap *soap = this->soap;
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name8__GetEventProperties.tev__GetEventProperties = tev__GetEventProperties;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name8__GetEventProperties(soap, &soap_tmp___name8__GetEventProperties);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name8__GetEventProperties(soap, &soap_tmp___name8__GetEventProperties, "-name8:GetEventProperties", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
