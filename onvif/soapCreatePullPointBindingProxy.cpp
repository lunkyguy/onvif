...
int CreatePullPointBindingProxy::CreatePullPoint(const char *endpoint, const char *soap_action, _wsnt__CreatePullPoint *wsnt__CreatePullPoint, _wsnt__CreatePullPointResponse *wsnt__CreatePullPointResponse)
{	struct soap *soap = this->soap;
	...
	soap_tmp___name13__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name13__CreatePullPoint(soap, &soap_tmp___name13__CreatePullPoint);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name13__CreatePullPoint(soap, &soap_tmp___name13__CreatePullPoint, "-name13:CreatePullPoint", NULL)
