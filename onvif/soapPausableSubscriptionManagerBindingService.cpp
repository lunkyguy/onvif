...
static int serve___name14__Renew(PausableSubscriptionManagerBindingService*);
static int serve___name14__Unsubscribe(PausableSubscriptionManagerBindingService*);
static int serve___name14__PauseSubscription(PausableSubscriptionManagerBindingService*);
static int serve___name14__ResumeSubscription(PausableSubscriptionManagerBindingService*);
...
{	PausableSubscriptionManagerBindingService_init(this->soap->imode, this->soap->omode);
	...
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:Renew"))
		return serve___name14__Renew(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:Unsubscribe"))
		return serve___name14__Unsubscribe(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:PauseSubscription"))
		return serve___name14__PauseSubscription(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:ResumeSubscription"))
		return serve___name14__ResumeSubscription(this);
	return this->soap->error = SOAP_NO_METHOD;
}

static int serve___name14__Renew(PausableSubscriptionManagerBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name14__Renew(soap, &soap_tmp___name14__Renew);
	if (!soap_get___name14__Renew(soap, &soap_tmp___name14__Renew, "-name14:Renew", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->Renew(soap_tmp___name14__Renew.wsnt__Renew, &wsnt__RenewResponse);
	if (soap->error)
		return soap->error;
...
static int serve___name14__Unsubscribe(PausableSubscriptionManagerBindingService *service)
{	struct soap *soap = service->soap;
	struct __name14__Unsubscribe soap_tmp___name14__Unsubscribe;
	_wsnt__UnsubscribeResponse wsnt__UnsubscribeResponse;
	wsnt__UnsubscribeResponse.soap_default(soap);
	soap_default___name14__Unsubscribe(soap, &soap_tmp___name14__Unsubscribe);
	if (!soap_get___name14__Unsubscribe(soap, &soap_tmp___name14__Unsubscribe, "-name14:Unsubscribe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->Unsubscribe(soap_tmp___name14__Unsubscribe.wsnt__Unsubscribe, &wsnt__UnsubscribeResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name14__PauseSubscription(PausableSubscriptionManagerBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name14__PauseSubscription(soap, &soap_tmp___name14__PauseSubscription);
	if (!soap_get___name14__PauseSubscription(soap, &soap_tmp___name14__PauseSubscription, "-name14:PauseSubscription", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->PauseSubscription(soap_tmp___name14__PauseSubscription.wsnt__PauseSubscription, &wsnt__PauseSubscriptionResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name14__ResumeSubscription(PausableSubscriptionManagerBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name14__ResumeSubscription(soap, &soap_tmp___name14__ResumeSubscription);
	if (!soap_get___name14__ResumeSubscription(soap, &soap_tmp___name14__ResumeSubscription, "-name14:ResumeSubscription", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->ResumeSubscription(soap_tmp___name14__ResumeSubscription.wsnt__ResumeSubscription, &wsnt__ResumeSubscriptionResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
