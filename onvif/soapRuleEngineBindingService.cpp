...
static int serve___name5__GetSupportedRules(RuleEngineBindingService*);
static int serve___name5__CreateRules(RuleEngineBindingService*);
static int serve___name5__DeleteRules(RuleEngineBindingService*);
static int serve___name5__GetRules(RuleEngineBindingService*);
static int serve___name5__GetRuleOptions(RuleEngineBindingService*);
static int serve___name5__ModifyRules(RuleEngineBindingService*);
...
{	RuleEngineBindingService_init(this->soap->imode, this->soap->omode);
	...
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetSupportedRules"))
		return serve___name5__GetSupportedRules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:CreateRules"))
		return serve___name5__CreateRules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:DeleteRules"))
		return serve___name5__DeleteRules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetRules"))
		return serve___name5__GetRules(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:GetRuleOptions"))
		return serve___name5__GetRuleOptions(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "tan:ModifyRules"))
		return serve___name5__ModifyRules(this);
	return this->soap->error = SOAP_NO_METHOD;
}

static int serve___name5__GetSupportedRules(RuleEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name5__GetSupportedRules(soap, &soap_tmp___name5__GetSupportedRules);
	if (!soap_get___name5__GetSupportedRules(soap, &soap_tmp___name5__GetSupportedRules, "-name5:GetSupportedRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetSupportedRules(soap_tmp___name5__GetSupportedRules.tan__GetSupportedRules, &tan__GetSupportedRulesResponse);
	if (soap->error)
		return soap->error;
...
static int serve___name5__CreateRules(RuleEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name5__CreateRules(soap, &soap_tmp___name5__CreateRules);
	if (!soap_get___name5__CreateRules(soap, &soap_tmp___name5__CreateRules, "-name5:CreateRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->CreateRules(soap_tmp___name5__CreateRules.tan__CreateRules, &tan__CreateRulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name5__DeleteRules(RuleEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name5__DeleteRules(soap, &soap_tmp___name5__DeleteRules);
	if (!soap_get___name5__DeleteRules(soap, &soap_tmp___name5__DeleteRules, "-name5:DeleteRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->DeleteRules(soap_tmp___name5__DeleteRules.tan__DeleteRules, &tan__DeleteRulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name5__GetRules(RuleEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name5__GetRules(soap, &soap_tmp___name5__GetRules);
	if (!soap_get___name5__GetRules(soap, &soap_tmp___name5__GetRules, "-name5:GetRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetRules(soap_tmp___name5__GetRules.tan__GetRules, &tan__GetRulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name5__GetRuleOptions(RuleEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name5__GetRuleOptions(soap, &soap_tmp___name5__GetRuleOptions);
	if (!soap_get___name5__GetRuleOptions(soap, &soap_tmp___name5__GetRuleOptions, "-name5:GetRuleOptions", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetRuleOptions(soap_tmp___name5__GetRuleOptions.tan__GetRuleOptions, &tan__GetRuleOptionsResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve___name5__ModifyRules(RuleEngineBindingService *service)
{	struct soap *soap = service->soap;
	...
	soap_default___name5__ModifyRules(soap, &soap_tmp___name5__ModifyRules);
	if (!soap_get___name5__ModifyRules(soap, &soap_tmp___name5__ModifyRules, "-name5:ModifyRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->ModifyRules(soap_tmp___name5__ModifyRules.tan__ModifyRules, &tan__ModifyRulesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
