...
{ public:
	...
	virtual	int GetPresets(const char *endpoint, const char *soap_action, _timg__GetPresets *timg__GetPresets, _timg__GetPresetsResponse *timg__GetPresetsResponse);
	...
	virtual	int GetCurrentPreset(const char *endpoint, const char *soap_action, _timg__GetCurrentPreset *timg__GetCurrentPreset, _timg__GetCurrentPresetResponse *timg__GetCurrentPresetResponse);
	...
	virtual	int SetCurrentPreset(const char *endpoint, const char *soap_action, _timg__SetCurrentPreset *timg__SetCurrentPreset, _timg__SetCurrentPresetResponse *timg__SetCurrentPresetResponse);
};
#endif
