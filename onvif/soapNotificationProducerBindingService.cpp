...
static int serve___name10__Subscribe(NotificationProducerBindingService*);
static int serve___name10__GetCurrentMessage(NotificationProducerBindingService*);
...
{	NotificationProducerBindingService_init(this->soap->imode, this->soap->omode);
	...
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:Subscribe"))
		return serve___name10__Subscribe(this);
	if (!soap_match_tag(this->soap, this->soap->tag, "wsnt:GetCurrentMessage"))
		return serve___name10__GetCurrentMessage(this);
	return this->soap->error = SOAP_NO_METHOD;
}

static int serve___name10__Subscribe(NotificationProducerBindingService *service)
{	struct soap *soap = service->soap;
	struct __name10__Subscribe soap_tmp___name10__Subscribe;
	_wsnt__SubscribeResponse wsnt__SubscribeResponse;
	wsnt__SubscribeResponse.soap_default(soap);
	soap_default___name10__Subscribe(soap, &soap_tmp___name10__Subscribe);
	if (!soap_get___name10__Subscribe(soap, &soap_tmp___name10__Subscribe, "-name10:Subscribe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->Subscribe(soap_tmp___name10__Subscribe.wsnt__Subscribe, &wsnt__SubscribeResponse);
	if (soap->error)
		return soap->error;
...
static int serve___name10__GetCurrentMessage(NotificationProducerBindingService *service)
{	struct soap *soap = service->soap;
	struct __name10__GetCurrentMessage soap_tmp___name10__GetCurrentMessage;
	_wsnt__GetCurrentMessageResponse wsnt__GetCurrentMessageResponse;
	wsnt__GetCurrentMessageResponse.soap_default(soap);
	soap_default___name10__GetCurrentMessage(soap, &soap_tmp___name10__GetCurrentMessage);
	if (!soap_get___name10__GetCurrentMessage(soap, &soap_tmp___name10__GetCurrentMessage, "-name10:GetCurrentMessage", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetCurrentMessage(soap_tmp___name10__GetCurrentMessage.wsnt__GetCurrentMessage, &wsnt__GetCurrentMessageResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
