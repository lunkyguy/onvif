...
int PullPointBindingProxy::GetMessages(const char *endpoint, const char *soap_action, _wsnt__GetMessages *wsnt__GetMessages, _wsnt__GetMessagesResponse *wsnt__GetMessagesResponse)
{	struct soap *soap = this->soap;
	struct __name12__GetMessages soap_tmp___name12__GetMessages;
	if (endpoint)
	...
	soap_tmp___name12__GetMessages.wsnt__GetMessages = wsnt__GetMessages;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name12__GetMessages(soap, &soap_tmp___name12__GetMessages);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name12__GetMessages(soap, &soap_tmp___name12__GetMessages, "-name12:GetMessages", NULL)
...
int PullPointBindingProxy::DestroyPullPoint(const char *endpoint, const char *soap_action, _wsnt__DestroyPullPoint *wsnt__DestroyPullPoint, _wsnt__DestroyPullPointResponse *wsnt__DestroyPullPointResponse)
{	struct soap *soap = this->soap;
	struct __name12__DestroyPullPoint soap_tmp___name12__DestroyPullPoint;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_action == NULL)
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name12__DestroyPullPoint.wsnt__DestroyPullPoint = wsnt__DestroyPullPoint;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name12__DestroyPullPoint(soap, &soap_tmp___name12__DestroyPullPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name12__DestroyPullPoint(soap, &soap_tmp___name12__DestroyPullPoint, "-name12:DestroyPullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int PullPointBindingProxy::send_Notify(const char *endpoint, const char *soap_action, _wsnt__Notify *wsnt__Notify)
{	struct soap *soap = this->soap;
	struct __name12__Notify soap_tmp___name12__Notify;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_action == NULL)
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___name12__Notify.wsnt__Notify = wsnt__Notify;
	soap_set_version(soap, 2); /* SOAP1.2 */
	soap_serializeheader(soap);
	soap_serialize___name12__Notify(soap, &soap_tmp___name12__Notify);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name12__Notify(soap, &soap_tmp___name12__Notify, "-name12:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int PullPointBindingProxy::recv_Notify(struct __name12__Notify& tmp)
{	struct soap *soap = this->soap;

	struct __name12__Notify *_param_3 = &tmp;
	soap_default___name12__Notify(soap, _param_3);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___name12__Notify(soap, _param_3, "-name12:Notify", NULL);
