...
#define DEV_PASSWORD "admin12345"
...
int main(int argc, char* argv[])
{
	...
	{
		processEventLog(__FILE__, __LINE__, stdout, "wrong args,usage: ./OpenCamera.exe 192.168.1.64 ");
		return -1;
	}
	...
	if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyDevice.soap, NULL, DEV_PASSID, DEV_PASSWORD))
	{
		return -1;
	}
	...
	if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, NULL, DEV_PASSID, DEV_PASSWORD))
	{
		return -1;
	}
	...
	if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyEvent.soap, NULL, DEV_PASSID, DEV_PASSWORD))
	{
		return -1;
	}
